        ...
        <div class="row logo-header">
            ...
            <div class="col-md-7 d-flex align-items-center justify-content-center">
                <div class="h-border">
                    ...
                    <h5 class="h-name px-2">
                    Universal Academic and Scientific Publisher (UAS publisher)
                    </h5>
            ...
            <header id="header" class="header">
                <nav id="navbar" class="navbar order-last order-lg-0 bg-nav-dark">
                    <ul>
                        ...
                        <li><a class="nav-link scrollto " href="{{ url('manuscript') }}"> Submit Manuscript</a></li>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 footer-info">
                        ...
                        <p><i class="bi bi-geo-alt-fill"></i>
                            ...
                            <strong>Email:</strong> editor@jadcp.com<br><br>
                    ...
                    <!--        &nbsp; &nbsp; &nbsp; Philippines 3500<br>-->
                    <!--        <i class="bi bi-envelope"></i>-->
                    <!--        <strong>Email:</strong> contact@IRASSpublishers.com<br><br>-->
                    <!--    </p>-->
