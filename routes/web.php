...
//     return view('usa_about');
// });
Route::get('/aim-and-scope', function () {
    return view('usa_aim_and_scope');
});

Route::get('/about-us', [JournalController::class, 'aboutUs']);
...
Route::get('manuscript/{slug}', [IndexController::class, 'manuscript']);
...
Route::group(['middleware'=>['AuthCheck']], function(){
    ...
    Route::get('addDynamicPages/{type}', [adminPanelController::class, 'addDynamicPages']);
